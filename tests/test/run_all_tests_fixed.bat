...
javac -d %BIN_DIR% -cp %CLASSPATH% core\Character.java core\Student.java core\NPC.java interfaces\GameAction.java events\Event.java events\StudyEvent.java events\QuizEvent.java events\RandomEncounter.java locations\Location.java locations\Library.java locations\Cafeteria.java locations\LectureHall.java utils\GamePrinter.java utils\InputHelper.java Main.java 2^>compile_errors.txt
...
javac -d %BIN_DIR% -cp "%CLASSPATH%;%BIN_DIR%" tests\Task1StudentTests.java tests\Task2LocationTests.java tests\Task3EventTests.java tests\Task4CharacterNpcTests.java tests\Task5MainFlowTests.java tests\Task6PrinterTests.java 2^>test_compile_errors.txt
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task1StudentTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task2LocationTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task3EventTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task4CharacterNpcTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task5MainFlowTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
...
echo ----------------------------------------------------------------
java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task6PrinterTests 2^>^&1 | findstr /C:"OK" >nul
if %errorlevel%==0 (
    echo [PASS] GamePrinter tests passed!
    set /a PASSED_TESTS+=1
) else (
    echo [FAIL] GamePrinter tests failed.
    java -cp "%CLASSPATH%;%BIN_DIR%" org.junit.runner.JUnitCore tests.Task6PrinterTests
)
set /a TOTAL_TESTS+=1
echo.
